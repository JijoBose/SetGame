...
class PlayerCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_card" do
    assert_difference('PlayerCard.count') do
      post player_cards_url, params: { player_card: { card_id: @player_card.card_id, round_id: @player_card.round_id, user_id: @player_card.user_id } }
    end
  ...
  test "should update player_card" do
    patch player_card_url(@player_card), params: { player_card: { card_id: @player_card.card_id, round_id: @player_card.round_id, user_id: @player_card.user_id } }
