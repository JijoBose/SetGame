...
class MatchPlayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create match_player" do
    assert_difference('MatchPlayer.count') do
      post match_players_url, params: { match_player: { match_id: @match_player.match_id, user_id: @match_player.user_id } }
    end
  ...
  test "should update match_player" do
    patch match_player_url(@match_player), params: { match_player: { match_id: @match_player.match_id, user_id: @match_player.user_id } }
